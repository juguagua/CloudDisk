...
CREATE TABLE `tbl_file`  (
  ...
  `create_at` datetime(0) NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建日期',
  `update_at` datetime(0) NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP(0) COMMENT '更新日期',
  `status` int(11) NOT NULL DEFAULT 0 COMMENT '状态(可用/禁用/已删除等状态)',
  `ext1` int(11) NULL DEFAULT 0 COMMENT '备用字段1',
...
CREATE TABLE `tbl_user`  (
  ...
  `signup_at` datetime(0) NULL DEFAULT CURRENT_TIMESTAMP COMMENT '注册日期',
  `last_active` datetime(0) NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP(0) COMMENT '最后活跃时间戳',
...
CREATE TABLE `tbl_user_file`  (
  ...
  `upload_at` datetime(0) NULL DEFAULT CURRENT_TIMESTAMP COMMENT '上传时间',
  `last_update` datetime(0) NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP(0) COMMENT '最后修改时间',
  `status` int(11) NOT NULL DEFAULT 0 COMMENT '文件状态(0正常1已删除2禁用)',
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `idx_user_file`(`user_name`, `file_sha1`) USING BTREE,
  INDEX `idx_status`(`status`) USING BTREE,
  INDEX `idx_user_id`(`user_name`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 2 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `tbl_user_token`  (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `user_name` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL DEFAULT '' COMMENT '用户名',
  `user_token` char(40) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL DEFAULT '' COMMENT '用户登录token',
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `idx_username`(`user_name`) USING BTREE
